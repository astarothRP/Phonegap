var app = {
  ...
  pintaCoordenadasEnMapa: function(position){
    ...
    L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/outdoors-v10/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoiYXN0YXJvdGgiLCJhIjoiY2l5aW9uNWhuMDA1MjJ3cGZlOTYxNzUzNiJ9.onE4pTokcbTHmduNhnst5A', {
